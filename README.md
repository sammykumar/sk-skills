...
| **[figma-design-agent](./skills/engineering/figma-design-agent/SKILL.md)** | Engineering | User-invoked | Create or iterate editable Figma product designs from a verified runtime baseline, with explicit source contracts, review gates, separate visual and structural QA, and a durable design-state ledger. |
