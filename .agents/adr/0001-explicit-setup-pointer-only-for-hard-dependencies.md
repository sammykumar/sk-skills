...
- **Hard dependency** (`to-tasks`, `to-spec`, `triage`): include an explicit one-liner: _"… should have been provided to you; run `/setup-sk-skills` if not."_ Without the mapping, output is wrong, not just fuzzy.
